...
class PeakFilterPedal(BasePedal):
    """
    a class to represent a PeakFilter Pedal
    """

    DRAW_KWARGS = {"fill": "#f0c880", "radius": 20, "padx": 1, "aspect": 2 / 3}
    ...
    def draw(self, x, y1, y2):
        ...
        self.canvas.create_text(self.rel_pos(.5, .6), text="PeakFilter", fill="white", font=("Comic Sans MS", 30, "italic bold"), tags=self.tags)
